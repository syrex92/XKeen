...
curl -s -L https://raw.githubusercontent.com/syrex92/XKeen/main/ublock/config --output /opt/etc/unblock/config
curl -s -L https://raw.githubusercontent.com/syrex92/XKeen/main/ublock/xkeen_parser.sh --output /opt/sbin/xkeen_parser
curl -s -L https://raw.githubusercontent.com/syrex92/XKeen/main/ublock/S24xray --output /opt/etc/init.d/S24xray
